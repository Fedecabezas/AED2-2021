...
public class SeleccionTests {
    ...
    @Test
    public void testSeleccionAleatorio() {
        int[] resultado10 = clasificar(datoAleatorio10, METODO_CLASIFICACION_SELECCION);
        int[] resultado100 = clasificar(datoAleatorio100, METODO_CLASIFICACION_SELECCION);
        int[] resultado1000 = clasificar(datoAleatorio1000, METODO_CLASIFICACION_SELECCION);
    ...
    public void testSeleccionAscendente() {
        int[] resultado10 = clasificar(datoAscendente10, METODO_CLASIFICACION_SELECCION);
        int[] resultado100 = clasificar(datoAscendente100, METODO_CLASIFICACION_SELECCION);
        int[] resultado1000 = clasificar(datoAscendente1000, METODO_CLASIFICACION_SELECCION);
    ...
    public void testSeleccionDescendente() {
        int[] resultado10 = clasificar(datoDescendete10, METODO_CLASIFICACION_SELECCION);
        int[] resultado100 = clasificar(datoDescendete100, METODO_CLASIFICACION_SELECCION);
        int[] resultado1000 = clasificar(datoDescendete1000, METODO_CLASIFICACION_SELECCION);
