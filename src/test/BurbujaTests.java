...
public class BurbujaTests {
    ...
    public void testBurbujaAleatorio() {
        int[] resultado10 = clasificar(datoAleatorio10, METODO_CLASIFICACION_BURBUJA);
        int[] resultado100 = clasificar(datoAleatorio100, METODO_CLASIFICACION_BURBUJA);
        int[] resultado1000 = clasificar(datoAleatorio1000, METODO_CLASIFICACION_BURBUJA);
    ...
    public void testBurbujaAscendente() {
        int[] resultado10 = clasificar(datoAscendente10, METODO_CLASIFICACION_BURBUJA);
        int[] resultado100 = clasificar(datoAscendente100, METODO_CLASIFICACION_BURBUJA);
        int[] resultado1000 = clasificar(datoAscendente1000, METODO_CLASIFICACION_BURBUJA);
    ...
    public void testBurbujaDescendente() {
        int[] resultado10 = clasificar(datoDescendete10, METODO_CLASIFICACION_BURBUJA);
        int[] resultado100 = clasificar(datoDescendete100, METODO_CLASIFICACION_BURBUJA);
        int[] resultado1000 = clasificar(datoDescendete1000, METODO_CLASIFICACION_BURBUJA);
