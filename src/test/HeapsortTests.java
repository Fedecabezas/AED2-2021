...
public class HeapsortTests {
    ...
    public void testHeapsortAleatorio() {
        int[] resultado10 = clasificar(datoAleatorio10, METODO_CLASIFICACION_HEAPSORT);
    ...
    public void testHeapsortAscendente() {
        int[] resultado10 = clasificar(datoAscendente10, METODO_CLASIFICACION_HEAPSORT);
    ...
    public void testHeapsortDescendente() {
        int[] resultado10 = clasificar(datoDescendete10, METODO_CLASIFICACION_HEAPSORT);
